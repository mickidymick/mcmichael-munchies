  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView style={[styles.container, { backgroundColor: colors.background }]} contentContainerStyle={styles.content}>
        ...
        <TextInput style={[styles.input, { backgroundColor: colors.surface, borderColor: colors.border, color: colors.text }]} placeholder="e.g. Grandma's Apple Pie" placeholderTextColor={colors.textSecondary} value={title} onChangeText={setTitle} maxLength={200} />

        <Text style={[styles.label, { color: colors.text }]}>Description</Text>
        <TextInput style={[styles.input, styles.multiline, { backgroundColor: colors.surface, borderColor: colors.border, color: colors.text }]} placeholder="A short description..." placeholderTextColor={colors.textSecondary} value={description} onChangeText={setDescription} multiline numberOfLines={3} maxLength={1000} />

        <Text style={[styles.label, { color: colors.text }]}>Notes</Text>
        <TextInput style={[styles.input, styles.multiline, { backgroundColor: colors.surface, borderColor: colors.border, color: colors.text }]} placeholder="Source, tips, variations, personal notes..." placeholderTextColor={colors.textSecondary} value={notes} onChangeText={setNotes} multiline numberOfLines={3} maxLength={1000} />

        <Text style={[styles.label, { color: colors.text }]}>Categories</Text>
        <View style={styles.chipWrap}>
          {CATEGORIES.map((c) => (
            <TouchableOpacity key={c} style={[styles.chip, { backgroundColor: colors.surface, borderColor: colors.border }, categories.includes(c) && styles.chipActive]} onPress={() => toggleCategory(c)} dataSet={{ hover: 'chip' }}>
        ...
        <View style={styles.chipWrap}>
          {FAMILIES.map((f) => (
            <TouchableOpacity key={f} style={[styles.chip, { backgroundColor: colors.surface, borderColor: colors.border }, family === f && styles.chipActive]} onPress={() => setFamily(family === f ? '' : f)} dataSet={{ hover: 'chip' }}>
        ...
        <View style={styles.chipWrap}>
          {CUISINES.map((c) => (
            <TouchableOpacity key={c} style={[styles.chip, { backgroundColor: colors.surface, borderColor: colors.border }, cuisine === c && styles.chipActive]} onPress={() => setCuisine(c)} dataSet={{ hover: 'chip' }}>
          ...
          {tagsFocused && tagSuggestions.length > 0 && (
            <View style={[styles.suggestionsBox, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              {tagSuggestions.map((tag) => (
                <TouchableOpacity key={tag} style={[styles.suggestionItem, { borderBottomColor: colors.border }]} onPress={() => acceptTag(tag)}>
        ...
        <View style={styles.timeRow}>
          <View style={styles.timeField}>
            ...
            <TextInput style={[styles.input, { backgroundColor: colors.surface, borderColor: colors.border, color: colors.text }]} placeholder="e.g. 15" placeholderTextColor={colors.textSecondary} value={prepTime} onChangeText={setPrepTime} keyboardType="numeric" />
          </View>
          <View style={styles.timeField}>
            <Text style={[styles.label, { color: colors.text }]}>Cook Time (min)</Text>
            <TextInput style={[styles.input, { backgroundColor: colors.surface, borderColor: colors.border, color: colors.text }]} placeholder="e.g. 30" placeholderTextColor={colors.textSecondary} value={cookTime} onChangeText={setCookTime} keyboardType="numeric" />
          </View>
          <View style={styles.timeField}>
            <Text style={[styles.label, { color: colors.text }]}>Servings</Text>
            <TextInput style={[styles.input, { backgroundColor: colors.surface, borderColor: colors.border, color: colors.text }]} placeholder="e.g. 4 or 4-6" placeholderTextColor={colors.textSecondary} value={servings} onChangeText={setServings} />
          </View>
        </View>
        ...
        {ingredients.map((ing, i) => (
          ...
          >
            ...
            <TextInput style={[styles.input, styles.amountInput, { backgroundColor: colors.surface, borderColor: colors.border, color: colors.text }]} placeholder="Amt" placeholderTextColor={colors.textSecondary} value={ing.amount} onChangeText={(v) => updateIngredient(i, 'amount', v)} />
              ...
              {ingredientFocusIndex === i && getIngredientSuggestions(i).length > 0 && (
                <View style={[styles.ingredientSuggestions, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                  {getIngredientSuggestions(i).map((name) => (
                    <TouchableOpacity key={name} style={[styles.suggestionItem, { borderBottomColor: colors.border }]} onPress={() => acceptIngredient(i, name)}>
        ...
        {steps.map((step, i) => (
          ...
          >
            ...
            <TextInput style={[styles.input, styles.multiline, { backgroundColor: colors.surface, borderColor: colors.border, color: colors.text }]} placeholder="Describe this step..." placeholderTextColor={colors.textSecondary} value={step.instruction} onChangeText={(v) => updateStep(i, v)} multiline numberOfLines={3} />
            {step.image_url ? (
              <View>
